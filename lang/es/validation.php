...
return [
    ...
    'password'             => [
        ...
        'uncompromised' => 'La contraseña :attribute ha aparecido en una filtración de datos. Por favor elige otra contraseña.',
    ],
    ...
    'attributes' => [
        ...
        'pallet_type_id'    => 'tipo de pallet',
        'min_pallets'       => 'pallets mínimo',
        'max_pallets'       => 'pallets máximo',
        'price_eur'         => 'precio',
        'carrier_rate_name' => 'nombre de tarifa',
        'base_length_cm'    => 'largo base',
        'base_width_cm'     => 'ancho base',
        'max_height_cm'     => 'altura máxima',
        'max_weight_kg'     => 'peso máximo',
        'length_cm'         => 'largo',
        'width_cm'          => 'ancho',
        'height_cm'         => 'alto',
        'weight_kg'         => 'peso',
        'security_separator_every_n_layers' => 'separador de seguridad',
        'provider_type'     => 'tipo de proveedor',
        'unit_cost_eur'     => 'coste unitario',
        'on_hand_qty'       => 'stock en mano',
        'is_active'         => 'estado',
